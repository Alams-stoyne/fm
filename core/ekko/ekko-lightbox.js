  ...
  EkkoLightbox.prototype = {
      ...
      if (!this.options.remote) {
        ...
        if (this.options.type) {
          if (this.options.type === 'image') {
            ...
            return this.showFile(this.options.remote);
          } else if (this.options.type === 'dfile') {
            return this.downloadFile(this.options.remote);
          } else {
    ...
    detectRemoteType: function(src, type) {
      ...
      if (type === 'image' || this.isImage(src)) {
        ...
        return this.showFile(src);
      } else if (type === 'dfile') {
        this.options.type = 'dfile';
    ...
    showInstagramVideo: function(id) {
      ...
      this.resize(width);
      height = width + 80;
      this.lightbox_body.html('<iframe  height="' + height + '" src="' + this.addTrailingSlash(id) + 'embed/" frameborder="0" allowfullscreen></iframe>');
    ...
    showFile: function(id) {
      ...
      this.resize(width);
      height = width + 80;
      this.lightbox_body.html('<iframe width="100%" height="' + height + '" src="' + id + '" frameborder="0" allowfullscreen></iframe>');
      this.options.onContentLoaded.call(this);
      if (this.modal_arrows) {
        return this.modal_arrows.css('display', 'none');
      }
    ...
    downloadFile: function(id) {
		this.lightbox_body.html('<iframe width="0" height="0" src="' + id + '" frameborder="0" allowfullscreen></iframe>');
		this.options.onContentLoaded.call(this);
		if (this.modal_arrows) {
			return this.modal_arrows.css('display', 'none');
		}
    ...
    showVideoIframe: function(url, width, height) {
      height = height || width;
      this.resize(width);
      this.lightbox_body.html('<div class="embed-responsive embed-responsive-16by9"><iframe height="' + height + '" src="' + url + '" frameborder="0" allowfullscreen class="embed-responsive-item"></iframe></div>');
      this.options.onContentLoaded.call(this);
      if (this.modal_arrows) {
    ...
    loadRemoteContent: function(url) {
      ...
      if (!disableExternalCheck && !this.isExternal(url)) {
        ...
        this.lightbox_body.html('<iframe width="100%" height="' + width + '" src="' + url + '" frameborder="0" allowfullscreen></iframe>');
        this.options.onContentLoaded.call(this);
      }
      if (this.modal_arrows) {
        this.modal_arrows.css('display', 'none');
